    ...
    <div className="flex relative flex-col gap-4 w-full">
      ...
      **/}
      ...
      <input
        ...
        ref={fileInputRef}
        accept="image/png,image/jpeg,application/pdf,text/plain,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        multiple
