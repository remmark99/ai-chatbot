...
const RemmarkPDFTemplate = ({
  ...
  const listItems = [
    ...
    `2. Срок поставки товара: в срок до ${content.deliveryPeriod} (включительно).`,
    `3. Место поставки товара: ${content.deliveryAddress}`,
    `4. Цена включает в себя: стоимость Товара, расходы, связанные с доставкой, разгрузкой-погрузкой, размещением в местах хранения Заказчика, стоимость упаковки (тары), маркировки, страхование, таможенные платежи (пошлины), НДС, другие установленные налоги, сборы и иные расходы, связанные с исполнением Контракта.`,
        ...
        <div>
          ...
          <ol className="mt-3 ml-6 list-none">
            {listItems.map((text, index) => {
              ...
              return content.itemsToShow && content.itemsToShow[index] ? (
